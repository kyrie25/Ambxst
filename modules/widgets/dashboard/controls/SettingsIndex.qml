...
QtObject {
    ...
    readonly property var staticItems: [
        ...
        // System > Night Light
        { label: "Night Light", keywords: "blue light filter hyprsunset warm screen", section: 6, subSection: "nightlight", subLabel: "System > Night Light", icon: Icons.nightLight, isIcon: true },
        { label: "Night Light Temperature", keywords: "warm cool kelvin color hyprsunset", section: 6, subSection: "nightlight", subLabel: "System > Night Light", icon: Icons.nightLight, isIcon: true },
        { label: "Night Light Gamma", keywords: "brightness dim perceived hyprsunset", section: 6, subSection: "nightlight", subLabel: "System > Night Light", icon: Icons.nightLight, isIcon: true },
        { label: "Night Light Schedule", keywords: "automatic time profile sunset sunrise", section: 6, subSection: "nightlight", subLabel: "System > Night Light", icon: Icons.nightLight, isIcon: true },
